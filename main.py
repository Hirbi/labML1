...
if __name__ == '__main__':
    params_xgb = {
        ...
        "eval_metric": 'logloss', # показатели оценки
        "eta": 0.05, # предотвращение переобучения
        "max_depth": 3, # максимальная глубина дерева
        "subsample": 1, # выборка данных
        "colsample_bytree": 0.8, # подвыборка для столбцов каждого дерева
    }

    num_boost_round = 100 # количество итераций повышения
    early_stopping_rounds = 10 # когда остановиться
